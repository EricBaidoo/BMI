...
<div class="flex flex-col lg:flex-row h-[calc(100vh-5rem)] md:h-[calc(100vh-6rem)] mt-20 md:mt-24 bg-[#0f0f11] overflow-hidden">
    ...
    <div class="flex-grow flex flex-col relative overflow-hidden bg-black">
        ...
        <div class="flex-grow flex items-center justify-center p-4 lg:p-8">
            <div class="w-full aspect-video max-h-full relative shadow-2xl bg-[#1a1a1f] overflow-hidden ">
    ...
    <div class="w-full lg:w-[25rem] flex-shrink-0 bg-[#f8f9fa] flex flex-col h-[50vh] lg:h-full border-l border-slate-200 z-20">
        ...
        <div class="flex-grow overflow-y-auto p-4 md:p-5 relative bg-[#f8f9fa]" id="sidebar-content">
            ...
            <div id="tab-schedule" class="space-y-6 block">
                <!-- Up Next Card -->
                <div>
                    <div class="bg-white border border-slate-100  p-5 shadow-[0_2px_10px_rgba(0,0,0,0.04)] relative overflow-hidden">
                        ...
                        <p class="text-[0.8125rem] text-slate-500 font-medium mt-1 mb-5">Restful Living</p>
                ...
                <!-- Future Events List -->
                <div>
                    <p class="text-[0.6875rem] font-bold text-slate-400 uppercase tracking-wider mb-2 pl-1">Wednesday, June 3</p>
                    <div class="bg-white border border-slate-100  p-4 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
                        <p class="font-bold text-[0.9375rem] text-slate-900">6:00PM</p>
                        <p class="text-xs text-slate-500 font-medium mt-0.5">Restful Living</p>
                    </div>
                </div>
                
                <div>
                    <p class="text-[0.6875rem] font-bold text-slate-400 uppercase tracking-wider mb-2 pl-1 mt-6">Sunday, June 7</p>
                    <div class="space-y-2">
                        <div class="bg-white border border-slate-100  p-4 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
                            <p class="font-bold text-[0.9375rem] text-slate-900">8:30AM</p>
                            <p class="text-xs text-slate-500 font-medium mt-0.5">Celebration Service</p>
                        </div>
                        <div class="bg-white border border-slate-100  p-4 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
                            <p class="font-bold text-[0.9375rem] text-slate-900">5:00PM</p>
                ...
                <div>
                    <p class="text-[0.6875rem] font-bold text-slate-400 uppercase tracking-wider mb-2 pl-1 mt-6">Wednesday, June 10</p>
                    <div class="bg-white border border-slate-100  p-4 shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
                        <p class="font-bold text-[0.9375rem] text-slate-900">6:00PM</p>
                        <p class="text-xs text-slate-500 font-medium mt-0.5">Restful Living</p>
                    </div>

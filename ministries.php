    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <?php if (empty($ministries)): ?>
            ...
            <div class="text-center py-10">
                <div class="max-w-2xl mx-auto bg-slate-900 p-12 border border-slate-800 flex flex-col items-center justify-center">
                    ...
                    <p class="text-slate-400 text-lg mb-8 font-light">Ministry groups will be listed here soon. Please contact the church office to learn how to get involved.</p>
        ...
        <?php else: ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                ?>
                    <div class="group bg-slate-900 border border-slate-800 hover:border-[#c49a45] p-8 transition-all duration-300 shadow-sm hover:shadow-[0_8px_30px_rgba(196,154,69,0.15)] flex flex-col h-full">
                        <div class="flex items-center gap-5 mb-6">
                            <div class="w-16 h-16 bg-slate-800 border border-slate-700 flex flex-shrink-0 items-center justify-center text-[#c49a45] font-display font-black text-2xl group-hover:bg-[#c49a45] group-hover:text-white transition-colors duration-300">
                                <?php echo e($iconLetter); ?>
                            </div>
                            <h2 class="font-bold text-2xl text-white leading-tight group-hover:text-[#c49a45] transition-colors"><?php echo e($m['name']); ?></h2>
                        </div>
                        
                        <div class="flex-grow space-y-4">
                            <?php if (!empty($m['description'])): ?>
                                <p class="text-slate-400 leading-relaxed text-sm"><?php echo e($m['description']); ?></p>
                            <?php endif; ?>
                                ...
                                <div class="pt-4 mt-auto border-t border-slate-800 space-y-2">
                                    <?php if (!empty($m['leader_name'])): ?>
                                        <div class="flex items-center gap-3 text-sm">
                                            ...
                                            <span class="text-slate-300 font-medium">Leader:</span>
                                            <span class="text-slate-400"><?php echo e($m['leader_name']); ?></span>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if (!empty($m['meeting_schedule'])): ?>
                                        <div class="flex items-center gap-3 text-sm">
                                            ...
                                            <span class="text-slate-300 font-medium">Meets:</span>
                                            <span class="text-slate-400"><?php echo e($m['meeting_schedule']); ?></span>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>

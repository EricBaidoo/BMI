...
<section class="page-hero">
    <div class="max-w-6xl mx-auto px-4 py-20 text-center">
        ...
        <div class="mt-8 flex flex-wrap justify-center gap-3">
            <a href="index.php" class="primary-action">Go Home</a>
            <a href="sermons.php" class="secondary-action">Sermons</a>
            <a href="events.php" class="secondary-action">Events</a>
            <a href="contact.php" class="secondary-action">Contact</a>
        </div>
    </div>
</section>

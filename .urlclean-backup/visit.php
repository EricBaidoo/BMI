...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['connect_card'])) {
    try {
        ...
        if (!empty($_POST['website_url'])) {
            $visitSuccess = true; // honeypot — silent success
        } else {
    ...
    <div>
        ...
        <div class="grid md:grid-cols-2 gap-4 mt-8">
            ...
            <div class="section-card">
                ...
                <p class="mt-2 text-sm muted-copy">Yes — if you can't make it in person, you can join us live online. <a href="livestream.php" class="text-teal-700 hover:underline">Watch live &rarr;</a></p>
            </div>
            <div class="section-card">

    ...
    $defaults = [
        ...
        ['social.links', json_encode([
            ...
            [
                'name' => 'TikTok',
                'url' => '',
                'icon' => '<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93v7.2c0 1.61-.39 3.23-1.18 4.61-1.22 2.14-3.4 3.56-5.83 3.94-2.38.38-4.95-.12-6.9-1.57-2.16-1.61-3.37-4.14-3.14-6.84.19-2.31 1.34-4.49 3.21-5.88 1.84-1.37 4.2-1.83 6.44-1.25V12.5c-1.36-.18-2.77-.07-4.04.54-1.25.6-2.22 1.63-2.68 2.89-.5 1.36-.45 2.92.14 4.24.63 1.41 1.85 2.47 3.33 2.87 1.51.4 3.14.22 4.49-.51 1.25-.68 2.15-1.84 2.52-3.19.16-.58.24-1.18.25-1.78l-.01-17.54h.01z"/></svg>'
            ]
        ]), 'social'],

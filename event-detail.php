...
<div class="pt-20 md:pt-24 bg-slate-50 min-h-screen">
    <?php if ($error || !$event): ?>
        <div class="max-w-3xl mx-auto px-4 py-32 text-center">
            ...
            <a href="events" class="inline-block bg-[#c49a45] text-white px-8 py-4 rounded-sm font-bold hover:bg-[#d4ac57] transition-colors">Return to Events</a>
        </div>
    <?php else: 
    ...
    <!-- EVENT HERO -->
    <section class="relative <?php echo $isFlagship ? 'h-[70vh] min-h-[600px]' : 'h-[50vh] min-h-[400px]'; ?> overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-none p-8 border border-slate-200 shadow-xl sticky top-32">
                        <h3 class="text-2xl font-display font-black text-slate-900 mb-6">Join Us</h3>
                        
                        <div class="space-y-6 mb-8">
                            <div class="flex items-start gap-4">
                                <div class="w-12 h-12 rounded-none bg-slate-50 flex items-center justify-center flex-shrink-0 text-[#c49a45]">
                        ...
                        <a href="#" class="block w-full bg-[#c49a45] text-white text-center px-6 py-4 rounded-none font-bold hover:bg-[#d4ac57] transition-all shadow-md hover:-translate-y-1">
                            Register Now
                        </a>
